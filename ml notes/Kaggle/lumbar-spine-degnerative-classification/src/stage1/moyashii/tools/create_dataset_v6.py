...
DST_DIR = SETTINGS.train_data_clean_dir / f'{args.user}/keypoint_datasets/v6'
...
# KEYPOIINT MODEL
SAGITTAL_KEYPOINT_TRAIN_CSV = SETTINGS.train_data_clean_dir / f'{args.user}/keypoint_datasets/v4/train_5folds.csv'
SAGITTAL_KEYPOINT_MODEL_INFO_F0 = [
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0005_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0005/exp0005_fold0_best_score.pth',
    },
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0012_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0012/exp0012_fold0_best_score.pth',
    },
]
SAGITTAL_KEYPOINT_MODEL_INFO_F1 = [
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0005_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0005/exp0005_fold1_best_score.pth',
    },
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0012_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0012/exp0012_fold1_best_score.pth',
    },
]
SAGITTAL_KEYPOINT_MODEL_INFO_F2 = [
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0005_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0005/exp0005_fold2_best_score.pth',
    },
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0012_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0012/exp0012_fold2_best_score.pth',
    },
]
SAGITTAL_KEYPOINT_MODEL_INFO_F3 = [
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0005_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0005/exp0005_fold3_best_score.pth',
    },
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0012_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0012/exp0012_fold3_best_score.pth',
    },
]
SAGITTAL_KEYPOINT_MODEL_INFO_F4 = [
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0005_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0005/exp0005_fold4_best_score.pth',
    },
    {
        'config': f'src/stage1/{args.user}/sagittal/config/v4_0012_config.yaml',
        'checkpoint': SETTINGS.model_checkpoint_dir / f'stage1/{args.user}/v4/0012/exp0012_fold4_best_score.pth',
    },
]
...
#
# Ver4の学習済みモデルを使ってラベルなしデータに疑似ラベルを付ける。
...
if not (DST_DIR / 'train_pseudo.csv').exists():
    ...
    for idx, study_id in enumerate(tqdm(st_ids, total=len(st_ids))):
        ...
        assert len(study_sagittal_kpt_train_df) == 1
        ...
        for desc in descs:
            ...
            stack = load_dicom_stack(dicom_folder, desc.split(' ')[0])
            # 椎間板レベルの位置を予測
            _, coords, _ = sagittal_kpt_detector.predict(stack)
